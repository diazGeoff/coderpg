...
<div class="form-group">
    ...
    <input type="name" name="name" class="form-control" id="name1" value="${playerInstance?.name}" placeholder="Your Name">
</div>
<div class="form-group">
    <label for="codename">Codename</label>
    <input type="name" name="codename" class="form-control" id="email1" placeholder="Enter email" maxlength="20" required="" value="${playerInstance?.codename}">
</div>
<div class="form-group">
    <label for="password">Password</label>
    <input type="password" name="Mail" class="form-control" id="email1" placeholder="Enter email" required="" value="${playerInstance?.password}">
</div>
<div class="form-group">
    <label for="email1">Re-type Password</label>
    <input type="password" name="Mail" class="form-control" id="email1" placeholder="Enter email">
</div>