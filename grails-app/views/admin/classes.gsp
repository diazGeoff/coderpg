        ...
        <g:each in="${classes}" status="i" var="classInstance">
            <div class="row margin-list">
                ...
                <div class="col-lg-3 img-centered">
                    <a href="/coderpg/quest/show/${classInstance.id}">
                ...
                <div class="col-lg-2">
                    <div class="btn-group pull-right">
                        <g:form>
                            ...
                            <g:link class="edit btn btn-default" controller="admin" action="editClass" id="${classInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
